...
nombre_modelo="modelo_random_forest_top1" #nombre del modelo que queremos usar para predecir
...
nombre_salida_csv="t_"+os.path.splitext(nombre_csv)[0]+"_scores.csv" #nombre del csv en el q se van a guardar los comentarios traducidos con scores

#guardamos en csv
df.to_csv(nombre_salida_csv,index=False)

print("El csv t_"+os.path.splitext(nombre_csv)[0]+"_scores.csv se ha guardado correctamente.")
